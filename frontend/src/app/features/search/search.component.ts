    ...
    <div class="max-w-7xl mx-auto px-4 animate-fade-in-up flex flex-col md:flex-row gap-8">
      ...
      <aside class="w-full md:w-64 flex-shrink-0">
        <div class="glass-panel p-6 sticky top-24">
          <h2 class="text-xl font-extrabold text-gray-900 mb-6">Filtres</h2>
          ...
          <div class="mb-6">
            ...
            <div class="flex items-center gap-2">
              ...
              <input type="number" [(ngModel)]="filters.max_price" placeholder="Max" class="w-full bg-gray-50 border border-gray-200 rounded-xl px-3 py-2 text-sm focus:ring-2 focus:ring-watermelon-pink/50 outline-none transition-all">
            </div>
          </div>
